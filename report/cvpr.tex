...
\begin{figure*}[ht!]
	...
	\subfloat[~Heads]{\includegraphics[width=0.2\textwidth]{images/pcs_stairs.png}}\,
	\subfloat[~Office]{\includegraphics[width=0.2\textwidth]{images/pcs_stairs.png}}
	\\
